...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="container-edge py-24 md:py-40 border-t border-line"
    >
      ...
      <div
        ref={linksRef}
        className="reveal mt-16 flex flex-wrap gap-x-10 gap-y-3 font-mono text-xs uppercase tracking-widest text-muted"
      >
        <a
          href={contact.github}
          target="_blank"
        ...
        <a href={`tel:${contact.phone}`} className="link-trace text-paper">
      ...
      <form
        ...
        className="reveal mt-16 max-w-xl grid gap-6"
      >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <label
              htmlFor="name"
              className="font-mono text-xs uppercase tracking-widest text-muted block mb-2"
            >
              Name
            </label>
            <input
